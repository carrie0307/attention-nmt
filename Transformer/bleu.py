...
if __name__ == '__main__':
    ...
    candidate = [['he', 'of', 'said', 'from', 'on', 'on', 'on', 'on', 'on', 'to', 'to', 'on', 'to', 'on', 'on', 'to', ',', 'to', 'to', 'to', ',', 'to', 'to', ',', 'to', 'to', 'to', 'to', 'to']]
    reference = [['however', ',', 'since', 'former', 'president', 'bush', 'approved', 'selling', 'f-16', 'fighters', 'to', 'taiwan', 'in', 'september', '1992', ',', 'the', '"', '17', 'august', 'communique', '"', 'has', 'existed', 'in', 'name', 'only', '.', '<EOS>']]
